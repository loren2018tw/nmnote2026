...
## 方法一：安裝非官方 snmp 服務（推薦）
Microsoft 已將內建 SNMP Service 標記為棄用，不再積極開發，未來版本可能移除。且內建 snmp 服務也缺少很多監控數據，所以建議另外安裝以下獨立程式。

 [jt-snmpd](https://jasoncheng7115.github.io/jt-snmpd/?lang=zh-TW)


## 方法二：開啟 win11 內建的 snmp 服務
