...
![1739498576677.png](1739498576677.png)

## 4. 流量排行

這裡的流量是以網路裝置的整體流量（因為這是網路裝置管理系統，管的是 **_裝置_** ），如果想知道哪個 ip 的流量應該是要去防火牆或是 netflow 的日誌系統看。
...
1.  ![](2024-06-17-10-50-09.png)

2.  或是後面會介紹的「自訂地圖」 （裝置連線流量圖）也會產生一個影像的連結，這個連結也可以讓它呈現在看板中。
    ![](2024-06-17-10-53-15.png)

## 6. 隱藏選單

在看板網址後面加上 **_?bare=yes_** 就可以顯示沒有編輯功能選單的看板，可用來作為電視牆展示之類的應用， Librenms 也提供選單可以切換這個 ex:

```
http://localhost/dashboard/1?bare=yes
```

![bare=yes](./dashboard-bare.png)
